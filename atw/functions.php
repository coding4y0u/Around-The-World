...
function my_responsive_thumbnail($post_id){
    ...
    // Get the ibfo for each image size including the original (full)
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('slicknav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.10'); // Slicknav
        wp_enqueue_script('slicknav'); // Enqueue it!

        wp_register_script('bxsliderjs', get_template_directory_uri() . '/js/jquery.bxslider.js', array(), '4.2.12'); // BxsliderJs
        wp_enqueue_script('bxsliderjs'); // Enqueue it!

        wp_register_script('fancybox', get_template_directory_uri() . '/js/jquery.fancybox.js', array(), '2.1.7'); // Modernizr
...
function html5blank_styles()
{
    ...
    wp_register_style('fancyboxcss', get_template_directory_uri() . '/css/jquery.fancybox.css', array(), '2.1.7', 'all');
    ...
    wp_register_style('LatoFont', 'https://fonts.googleapis.com/css?family=Lato:700
    ', array(), '1.0', 'all');
    wp_enqueue_style('LatoFont');

    wp_register_style('slickNavCss',get_template_directory_uri() .  '/css/slicknav.min.css
    ', array(), '1.0', 'all');
